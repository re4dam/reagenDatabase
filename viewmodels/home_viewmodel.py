...
class HomeViewModel(QObject):
    ...
    def show_record_manager(self):
        ...
        return self.record_viewmodel.show_record_view(self.home_view)
    ...
    def show_user_management(self):
        ...
        return self.user_viewmodel.show_user_view(self.home_view)
    ...
    def show_rack(self, storage_id, storage_name):
        ...
        return self.rack_viewmodels[storage_id].show_rack_view(self.home_view)
